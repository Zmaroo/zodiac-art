...
- Entry point: `zodiac_art/main.py` (CLI and example run).
- Config is in `zodiac_art/config.py` and uses env overrides.
- Frames live in `frames/` and output is written to `output/`.
